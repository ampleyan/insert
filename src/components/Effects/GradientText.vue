<template>
  <div class="gradient-container" @mousemove="handleMouseMove" @touchmove="handleTouchMove">
...
.gradient-text.draggable {
  transition: none;
}

.gradient-text.draggable:hover {
...
.gradient-text.draggable:hover .drag-handle {
  opacity: 1;
}
...
.gradient-text.draggable:hover .resize-handle {
  opacity: 1;
}
