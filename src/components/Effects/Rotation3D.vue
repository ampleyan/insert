<template>
  <div class="rotation3d-container" @mousemove="handleMouseMove" @touchmove="handleTouchMove">
...
.rotation3d-text.draggable {
  transition: none;
}

.rotation3d-text.draggable:hover {
...
.rotation3d-text.draggable:hover .drag-handle {
  opacity: 1;
}
...
.rotation3d-text.draggable:hover .resize-handle {
  opacity: 1;
}
